...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post facts_url, params: { fact: { color: @fact.color, description: @fact.description, provable: @fact.provable, real: @fact.real, title: @fact.title } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { color: @fact.color, description: @fact.description, provable: @fact.provable, real: @fact.real, title: @fact.title } }
